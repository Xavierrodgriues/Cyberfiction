...
<head>
    ...
    <title>Manager Panel - BOOKING RECORDS</title>
    <?php
                ...
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-body">
                        <div class="text-end mb-4">
                            <input type="text"  id="search_input" oninput="get_bookings(this.value)" placeholder="type  to search" class="form-control shadow-none w-25 ms-auto">
                        </div>
