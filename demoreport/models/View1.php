...
class View1 extends DbTable
{
    ...
    public function __construct()
    {
        ...
        $this->name->Lookup = new Lookup($this->name, 'view1', true, 'name', ["name","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->area->Lookup = new Lookup($this->area, 'view1', true, 'area', ["area","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->price->Lookup = new Lookup($this->price, 'view1', true, 'price', ["price","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->trans_amt->Lookup = new Lookup($this->trans_amt, 'view1', true, 'trans_amt', ["trans_amt","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("View1List");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "View1View" => $Language->phrase("View"),
            "View1Edit" => $Language->phrase("Edit"),
            "View1Add" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "View1View",
            Config("API_ADD_ACTION") => "View1Add",
            Config("API_EDIT_ACTION") => "View1Edit",
            Config("API_DELETE_ACTION") => "View1Delete",
            Config("API_LIST_ACTION") => "View1List",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("View1View", $parm);
        } else {
            $url = $this->keyUrl("View1View", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("View1Edit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("View1List", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("View1List", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("View1Delete", $parm);
        }
    }
