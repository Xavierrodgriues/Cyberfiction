...
$CONFIG = [
    ...
    "AES_ENCRYPTION_KEY" => "9XaUzR3v3VD1uzCbwCFyFf4J0ylrTQJG5Z5dkBU5UmA=", // AES encryption key (base64 encoded)
    ...
    "AUTH_CONFIG" => [
        "providers" => [
            ...
            "Azure" => [
                "enabled" => false,
                "adapter" => 'PHPMaker2024\\project1\\AzureAD',
                "keys" => [
                    "id" => '',
            ...
            "Saml" => [
                "enabled" => false,
                "adapter" => 'PHPMaker2024\\project1\\Saml2',
    ...
    // Export Log
    "EXPORT_PATH" => "export-2d8d5f35-98c8-46f4-bc2f-81c6fe1c511d", // Export folder
