...
$CONFIG = [
    ...
    "AES_ENCRYPTION_KEY" => "iNf+A8R9h9jjw6SJkGFk1JvMPOEUpFIhClgPxl6k0rU=", // AES encryption key (base64 encoded)
    ...
    // Export Log
    "EXPORT_PATH" => "export-7cb13844-9ded-4547-a04c-a4a533c4915a", // Export folder
