...
Type::addType("geometry", "PHPMaker2024\\project1\\GeometryType"); // "geometry" type
Type::addType("geography", "PHPMaker2024\\project1\\GeographyType"); // "geography" type
Type::addType("hierarchyid", "PHPMaker2024\\project1\\HierarchyIdType"); // "hierarchyid" type
Type::addType("bytes", "PHPMaker2024\\project1\\BytesType"); // "bytes" type
