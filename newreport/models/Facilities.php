...
/**
 * Table class for facilities
 */
class Facilities extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // icon
        $this->icon = new DbField(
            $this, // Table
            'x_icon', // Variable name
            'icon', // Name
            '`icon`', // Expression
            '`icon`', // Basic search expression
            200, // Type
            100, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`icon`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->icon->InputTextType = "text";
        $this->icon->Nullable = false; // NOT NULL field
        $this->icon->Required = true; // Required field
        $this->icon->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY"];
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "facilities";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("FacilitiesList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "FacilitiesView" => $Language->phrase("View"),
            "FacilitiesEdit" => $Language->phrase("Edit"),
            "FacilitiesAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "FacilitiesView",
            Config("API_ADD_ACTION") => "FacilitiesAdd",
            Config("API_EDIT_ACTION") => "FacilitiesEdit",
            Config("API_DELETE_ACTION") => "FacilitiesDelete",
            Config("API_LIST_ACTION") => "FacilitiesList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("FacilitiesView", $parm);
        } else {
            $url = $this->keyUrl("FacilitiesView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("FacilitiesEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("FacilitiesList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("FacilitiesAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("FacilitiesList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("FacilitiesDelete", $parm);
        }
    }
