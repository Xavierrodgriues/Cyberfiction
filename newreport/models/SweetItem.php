...
/**
 * Table class for sweet_item
 */
class SweetItem extends DbTable
{
    protected $SqlFrom = "";
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "sweet_item";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("SweetItemList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "SweetItemView" => $Language->phrase("View"),
            "SweetItemEdit" => $Language->phrase("Edit"),
            "SweetItemAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "SweetItemView",
            Config("API_ADD_ACTION") => "SweetItemAdd",
            Config("API_EDIT_ACTION") => "SweetItemEdit",
            Config("API_DELETE_ACTION") => "SweetItemDelete",
            Config("API_LIST_ACTION") => "SweetItemList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("SweetItemView", $parm);
        } else {
            $url = $this->keyUrl("SweetItemView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("SweetItemEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("SweetItemList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("SweetItemAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("SweetItemList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("SweetItemDelete", $parm);
        }
    }
