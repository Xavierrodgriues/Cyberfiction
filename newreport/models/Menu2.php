...
class Menu2 extends DbTable
{
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "menu";
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "Menu2View" => $Language->phrase("View"),
            "Menu2Edit" => $Language->phrase("Edit"),
            "Menu2Add" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "Menu2View",
            Config("API_ADD_ACTION") => "Menu2Add",
            Config("API_EDIT_ACTION") => "Menu2Edit",
            Config("API_DELETE_ACTION") => "Menu2Delete",
            Config("API_LIST_ACTION") => "Menu2List",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("Menu2View", $parm);
        } else {
            $url = $this->keyUrl("Menu2View", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("Menu2Edit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("Menu2List", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("Menu2List", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("Menu2Delete", $parm);
        }
    }
