...
/**
 * Table class for booking_order
 */
class BookingOrder extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "booking_order";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "booking_order";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("BookingOrderList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "BookingOrderView" => $Language->phrase("View"),
            "BookingOrderEdit" => $Language->phrase("Edit"),
            "BookingOrderAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "BookingOrderView",
            Config("API_ADD_ACTION") => "BookingOrderAdd",
            Config("API_EDIT_ACTION") => "BookingOrderEdit",
            Config("API_DELETE_ACTION") => "BookingOrderDelete",
            Config("API_LIST_ACTION") => "BookingOrderList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("BookingOrderView", $parm);
        } else {
            $url = $this->keyUrl("BookingOrderView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("BookingOrderEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("BookingOrderList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("BookingOrderAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("BookingOrderList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("BookingOrderDelete", $parm);
        }
    }
