...
$CONFIG = [
    ...
    "AES_ENCRYPTION_KEY" => "P9d8tWjbIpqRE1LKEL6sCJ2x6ePKSFz43nBnikGdj1U=", // AES encryption key (base64 encoded)
    ...
    "AUTH_CONFIG" => [
        "providers" => [
            ...
            "Azure" => [
                "enabled" => false,
                "adapter" => 'PHPMaker2024\\project3\\AzureAD',
                "keys" => [
                    "id" => '',
            ...
            "Saml" => [
                "enabled" => false,
                "adapter" => 'PHPMaker2024\\project3\\Saml2',
    ...
    // Export Log
    "EXPORT_PATH" => "export-be82ae00-c7bc-462d-8833-42ff3fb951d6", // Export folder
    "EXPORT_LOG_DBID" => "DB", // DB ID
    "EXPORT_LOG_TABLE_NAME" => "view2", // Table name
    "EXPORT_LOG_TABLE_VAR" => "view2", // Table var
