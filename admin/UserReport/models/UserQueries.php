...
/**
 * Table class for user_queries
 */
class UserQueries extends DbTable
{
    protected $SqlFrom = "";
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "user_queries";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("UserQueriesList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "UserQueriesView" => $Language->phrase("View"),
            "UserQueriesEdit" => $Language->phrase("Edit"),
            "UserQueriesAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "UserQueriesView",
            Config("API_ADD_ACTION") => "UserQueriesAdd",
            Config("API_EDIT_ACTION") => "UserQueriesEdit",
            Config("API_DELETE_ACTION") => "UserQueriesDelete",
            Config("API_LIST_ACTION") => "UserQueriesList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("UserQueriesView", $parm);
        } else {
            $url = $this->keyUrl("UserQueriesView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("UserQueriesEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("UserQueriesList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("UserQueriesAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("UserQueriesList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("UserQueriesDelete", $parm);
        }
    }
    ...
    public function renderEditRow()
    {
        ...
        if (!$this->_message->Raw) {
            $this->_message->CurrentValue = HtmlDecode($this->_message->CurrentValue);
        }
