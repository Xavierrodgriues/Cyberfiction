...
/**
 * Table class for carousel
 */
class Carousel extends DbTable
{
    protected $SqlFrom = "";
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "carousel";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("CarouselList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "CarouselView" => $Language->phrase("View"),
            "CarouselEdit" => $Language->phrase("Edit"),
            "CarouselAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "CarouselView",
            Config("API_ADD_ACTION") => "CarouselAdd",
            Config("API_EDIT_ACTION") => "CarouselEdit",
            Config("API_DELETE_ACTION") => "CarouselDelete",
            Config("API_LIST_ACTION") => "CarouselList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("CarouselView", $parm);
        } else {
            $url = $this->keyUrl("CarouselView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("CarouselEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("CarouselList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("CarouselAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("CarouselList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("CarouselDelete", $parm);
        }
    }
