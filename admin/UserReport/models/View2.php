...
class View2 extends DbTable
{
    ...
    public function __construct()
    {
        ...
        $this->name->Lookup = new Lookup($this->name, 'view2', true, 'name', ["name","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->_email->Lookup = new Lookup($this->_email, 'view2', true, 'email', ["email","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->phonenum->Lookup = new Lookup($this->phonenum, 'view2', true, 'phonenum', ["phonenum","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->is_verified->Lookup = new Lookup($this->is_verified, 'view2', true, 'is_verified', ["is_verified","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->status->Lookup = new Lookup($this->status, 'view2', true, 'status', ["status","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "View2View" => $Language->phrase("View"),
            "View2Edit" => $Language->phrase("Edit"),
            "View2Add" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "View2View",
            Config("API_ADD_ACTION") => "View2Add",
            Config("API_EDIT_ACTION") => "View2Edit",
            Config("API_DELETE_ACTION") => "View2Delete",
            Config("API_LIST_ACTION") => "View2List",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("View2View", $parm);
        } else {
            $url = $this->keyUrl("View2View", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("View2Edit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("View2List", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("View2List", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("View2Delete", $parm);
        }
    }
