...
/**
 * Table class for booking details report
 */
class BookingDetailsReport extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = "booking_details_report";
        $this->TableName = 'booking details report';
        $this->TableType = "VIEW";
        $this->ImportUseTransaction = $this->supportsTransaction() && Config("IMPORT_USE_TRANSACTION");
        $this->UseTransaction = $this->supportsTransaction() && Config("USE_TRANSACTION");

        // Update Table
        $this->UpdateTable = "`booking details report`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`booking details report`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("BookingDetailsReportList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "BookingDetailsReportView" => $Language->phrase("View"),
            "BookingDetailsReportEdit" => $Language->phrase("Edit"),
            "BookingDetailsReportAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    {
        return "BookingDetailsReportList";
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "BookingDetailsReportView",
            Config("API_ADD_ACTION") => "BookingDetailsReportAdd",
            Config("API_EDIT_ACTION") => "BookingDetailsReportEdit",
            Config("API_DELETE_ACTION") => "BookingDetailsReportDelete",
            Config("API_LIST_ACTION") => "BookingDetailsReportList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("BookingDetailsReportView", $parm);
        } else {
            $url = $this->keyUrl("BookingDetailsReportView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "BookingDetailsReportAdd?" . $parm;
        } else {
            $url = "BookingDetailsReportAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("BookingDetailsReportEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("BookingDetailsReportList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("BookingDetailsReportAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("BookingDetailsReportList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("BookingDetailsReportDelete", $parm);
        }
    }
    ...
    {
        global $Response;
        $listPage = "BookingDetailsReportList";
