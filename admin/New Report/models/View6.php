...
class View6 extends DbTable
{
    ...
    public function __construct()
    {
        ...
        $this->name->Lookup = new Lookup($this->name, 'view6', true, 'name', ["name","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->area->Lookup = new Lookup($this->area, 'view6', true, 'area', ["area","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->price->Lookup = new Lookup($this->price, 'view6', true, 'price', ["price","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->adult->Lookup = new Lookup($this->adult, 'view6', true, 'adult', ["adult","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->children->Lookup = new Lookup($this->children, 'view6', true, 'children', ["children","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->status->Lookup = new Lookup($this->status, 'view6', true, 'status', ["status","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->removed->Lookup = new Lookup($this->removed, 'view6', true, 'removed', ["removed","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "view6";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("View6List");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "View6View" => $Language->phrase("View"),
            "View6Edit" => $Language->phrase("Edit"),
            "View6Add" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "View6View",
            Config("API_ADD_ACTION") => "View6Add",
            Config("API_EDIT_ACTION") => "View6Edit",
            Config("API_DELETE_ACTION") => "View6Delete",
            Config("API_LIST_ACTION") => "View6List",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("View6View", $parm);
        } else {
            $url = $this->keyUrl("View6View", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("View6Edit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("View6List", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("View6List", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("View6Delete", $parm);
        }
    }
