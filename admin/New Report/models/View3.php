...
class View3 extends DbTable
{
    ...
    public function __construct()
    {
        ...
        $this->user_name->Lookup = new Lookup($this->user_name, 'view3', true, 'user_name', ["user_name","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->room_name->UseFilter = true; // Table header filter
        $this->room_name->Lookup = new Lookup($this->room_name, 'view3', true, 'room_name', ["room_name","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->price->InputTextType = "range";
        $this->price->Raw = true;
        ...
        $this->price->Lookup = new Lookup($this->price, 'view3', true, 'price', ["price","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->total_pay->InputTextType = "range";
        $this->total_pay->Raw = true;
        $this->total_pay->Nullable = false; // NOT NULL field
        $this->total_pay->Required = true; // Required field
        $this->total_pay->UseFilter = true; // Table header filter
        $this->total_pay->Lookup = new Lookup($this->total_pay, 'view3', true, 'total_pay', ["total_pay","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->check_in->InputTextType = "month";
        $this->check_in->Raw = true;
        $this->check_in->Nullable = false; // NOT NULL field
        $this->check_in->Required = true; // Required field
        $this->check_in->UseFilter = true; // Table header filter
        $this->check_in->Lookup = new Lookup($this->check_in, 'view3', true, 'check_in', ["check_in","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->check_out->InputTextType = "month";
        $this->check_out->Raw = true;
        $this->check_out->Nullable = false; // NOT NULL field
        $this->check_out->Required = true; // Required field
        $this->check_out->UseFilter = true; // Table header filter
        $this->check_out->Lookup = new Lookup($this->check_out, 'view3', true, 'check_out', ["check_out","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->refund->InputTextType = "range";
        $this->refund->Raw = true;
        $this->refund->UseFilter = true; // Table header filter
        $this->refund->Lookup = new Lookup($this->refund, 'view3', true, 'refund', ["refund","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->booking_status->UseFilter = true; // Table header filter
        $this->booking_status->Lookup = new Lookup($this->booking_status, 'view3', true, 'booking_status', ["booking_status","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->starter_name->UseFilter = true; // Table header filter
        $this->starter_name->Lookup = new Lookup($this->starter_name, 'view3', true, 'starter_name', ["starter_name","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->main_course_name->UseFilter = true; // Table header filter
        $this->main_course_name->Lookup = new Lookup($this->main_course_name, 'view3', true, 'main_course_name', ["main_course_name","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->sweet_dish_name->UseFilter = true; // Table header filter
        $this->sweet_dish_name->Lookup = new Lookup($this->sweet_dish_name, 'view3', true, 'sweet_dish_name', ["sweet_dish_name","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        // trans_id
        $this->trans_id = new DbField(
            $this, // Table
            'x_trans_id', // Variable name
            'trans_id', // Name
            '`trans_id`', // Expression
            '`trans_id`', // Basic search expression
            200, // Type
            150, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`trans_id`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->trans_id->InputTextType = "text";
        $this->trans_id->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        ...
        $this->trans_amt->UseFilter = true; // Table header filter
        $this->trans_amt->Lookup = new Lookup($this->trans_amt, 'view3', true, 'trans_amt', ["trans_amt","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->trans_status->UseFilter = true; // Table header filter
        $this->trans_status->Lookup = new Lookup($this->trans_status, 'view3', true, 'trans_status', ["trans_status","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->datentime->UseFilter = true; // Table header filter
        $this->datentime->Lookup = new Lookup($this->datentime, 'view3', true, 'datentime', ["datentime","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "view3";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("View3List");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "View3View" => $Language->phrase("View"),
            "View3Edit" => $Language->phrase("Edit"),
            "View3Add" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "View3View",
            Config("API_ADD_ACTION") => "View3Add",
            Config("API_EDIT_ACTION") => "View3Edit",
            Config("API_DELETE_ACTION") => "View3Delete",
            Config("API_LIST_ACTION") => "View3List",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("View3View", $parm);
        } else {
            $url = $this->keyUrl("View3View", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("View3Edit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("View3List", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("View3List", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("View3Delete", $parm);
        }
    }
