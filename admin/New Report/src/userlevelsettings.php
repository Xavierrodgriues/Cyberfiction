...
$USER_LEVEL_PRIVS = [["{71F36037-1BF5-4822-9F30-E73B5CBA89ED}admin_cred","-2","0"],
    ...
    ["{71F36037-1BF5-4822-9F30-E73B5CBA89ED}view6","-2","0"]];
 ...
 */
$USER_LEVEL_TABLES = [["admin_cred","admin_cred","admin cred",true,"{71F36037-1BF5-4822-9F30-E73B5CBA89ED}",""],
    ["booked_food","booked_food","booked food",true,"{71F36037-1BF5-4822-9F30-E73B5CBA89ED}",""],
    ...
    ["booking_details","booking_details","booking details",true,"{71F36037-1BF5-4822-9F30-E73B5CBA89ED}",""],
    ["booking_order","booking_order","booking order",true,"{71F36037-1BF5-4822-9F30-E73B5CBA89ED}",""],
    ["bookingorder report","bookingorder_report","bookingorder report",true,"{71F36037-1BF5-4822-9F30-E73B5CBA89ED}",""],
    ["carousel","carousel","carousel",true,"{71F36037-1BF5-4822-9F30-E73B5CBA89ED}",""],
    ["contact_details","contact_details","contact details",true,"{71F36037-1BF5-4822-9F30-E73B5CBA89ED}",""],
    ["facilities","facilities","facilities",true,"{71F36037-1BF5-4822-9F30-E73B5CBA89ED}",""],
    ["features","features","features",true,"{71F36037-1BF5-4822-9F30-E73B5CBA89ED}",""],
    ["main_course_item","main_course_item","main course item",true,"{71F36037-1BF5-4822-9F30-E73B5CBA89ED}",""],
    ["manager_cred","manager_cred","manager cred",true,"{71F36037-1BF5-4822-9F30-E73B5CBA89ED}",""],
    ["menu","menu2","menu",true,"{71F36037-1BF5-4822-9F30-E73B5CBA89ED}",""],
    ["rating_review","rating_review","rating review",true,"{71F36037-1BF5-4822-9F30-E73B5CBA89ED}",""],
    ["room_facilities","room_facilities","room facilities",true,"{71F36037-1BF5-4822-9F30-E73B5CBA89ED}",""],
    ["room_features","room_features","room features",true,"{71F36037-1BF5-4822-9F30-E73B5CBA89ED}",""],
    ["room_images","room_images","room images",true,"{71F36037-1BF5-4822-9F30-E73B5CBA89ED}",""],
    ["rooms","rooms","rooms",true,"{71F36037-1BF5-4822-9F30-E73B5CBA89ED}",""],
    ["settings","settings","settings",true,"{71F36037-1BF5-4822-9F30-E73B5CBA89ED}",""],
    ["starter_item","starter_item","starter item",true,"{71F36037-1BF5-4822-9F30-E73B5CBA89ED}",""],
    ["sweet_item","sweet_item","sweet item",true,"{71F36037-1BF5-4822-9F30-E73B5CBA89ED}",""],
    ["team_details","team_details","team details",true,"{71F36037-1BF5-4822-9F30-E73B5CBA89ED}",""],
    ["user_cred","user_cred","user cred",true,"{71F36037-1BF5-4822-9F30-E73B5CBA89ED}",""],
    ["user_queries","user_queries","user queries",true,"{71F36037-1BF5-4822-9F30-E73B5CBA89ED}",""],
    ...
    ["view5","view5","view 5",true,"{71F36037-1BF5-4822-9F30-E73B5CBA89ED}",""],
    ["view6","view6","view 6",true,"{71F36037-1BF5-4822-9F30-E73B5CBA89ED}","View6List"]];
