...
$CONFIG = [
    ...
    "AES_ENCRYPTION_KEY" => "fdCJvbwXadlX/h4yUj72jQjxU79hCx9dnlBgdfuX8FE=", // AES encryption key (base64 encoded)
    ...
    "AUTH_CONFIG" => [
        "providers" => [
            ...
            "Azure" => [
                "enabled" => false,
                "adapter" => 'PHPMaker2024\\project4\\AzureAD',
                "keys" => [
                    "id" => '',
            ...
            "Saml" => [
                "enabled" => false,
                "adapter" => 'PHPMaker2024\\project4\\Saml2',
    ...
    // Export Log
    "EXPORT_PATH" => "export-71f36037-1bf5-4822-9f30-e73b5cba89ed", // Export folder
