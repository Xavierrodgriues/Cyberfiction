...
class RoomImagesController extends ControllerBase
{
    // list
    #[Map(["GET","POST","OPTIONS"], "/RoomImagesList", [PermissionMiddleware::class], "list.room_images")]
    public function list(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "RoomImagesList");
    }
}
