...
class RoomFacilitiesController extends ControllerBase
{
    // list
    #[Map(["GET","POST","OPTIONS"], "/RoomFacilitiesList", [PermissionMiddleware::class], "list.room_facilities")]
    public function list(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "RoomFacilitiesList");
    }
}
