...
class View4Controller extends ControllerBase
{
    // list
    #[Map(["GET","POST","OPTIONS"], "/View4List", [PermissionMiddleware::class], "list.view4")]
    public function list(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "View4List");
    }
}
