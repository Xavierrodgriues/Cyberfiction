...
class UserQueriesController extends ControllerBase
{
    // list
    #[Map(["GET","POST","OPTIONS"], "/UserQueriesList", [PermissionMiddleware::class], "list.user_queries")]
    public function list(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "UserQueriesList");
    }
}
