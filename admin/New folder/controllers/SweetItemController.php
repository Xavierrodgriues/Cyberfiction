...
class SweetItemController extends ControllerBase
{
    // list
    #[Map(["GET","POST","OPTIONS"], "/SweetItemList", [PermissionMiddleware::class], "list.sweet_item")]
    public function list(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "SweetItemList");
    }
}
