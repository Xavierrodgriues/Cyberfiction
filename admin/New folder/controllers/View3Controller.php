...
class View3Controller extends ControllerBase
{
    // list
    #[Map(["GET","POST","OPTIONS"], "/View3List", [PermissionMiddleware::class], "list.view3")]
    public function list(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "View3List");
    }
}
