...
class StarterItemController extends ControllerBase
{
    // list
    #[Map(["GET","POST","OPTIONS"], "/StarterItemList", [PermissionMiddleware::class], "list.starter_item")]
    public function list(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "StarterItemList");
    }
}
