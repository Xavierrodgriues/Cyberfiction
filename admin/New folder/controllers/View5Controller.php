...
class View5Controller extends ControllerBase
{
    // list
    #[Map(["GET","POST","OPTIONS"], "/View5List", [PermissionMiddleware::class], "list.view5")]
    public function list(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "View5List");
    }
}
