...
class RoomFeaturesController extends ControllerBase
{
    // list
    #[Map(["GET","POST","OPTIONS"], "/RoomFeaturesList", [PermissionMiddleware::class], "list.room_features")]
    public function list(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "RoomFeaturesList");
    }
}
