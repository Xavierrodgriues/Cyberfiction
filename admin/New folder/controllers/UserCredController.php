...
class UserCredController extends ControllerBase
{
    // list
    #[Map(["GET","POST","OPTIONS"], "/UserCredList", [PermissionMiddleware::class], "list.user_cred")]
    public function list(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "UserCredList");
    }
}
