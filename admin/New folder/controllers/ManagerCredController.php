...
class ManagerCredController extends ControllerBase
{
    // list
    #[Map(["GET","POST","OPTIONS"], "/ManagerCredList", [PermissionMiddleware::class], "list.manager_cred")]
    public function list(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "ManagerCredList");
    }
}
