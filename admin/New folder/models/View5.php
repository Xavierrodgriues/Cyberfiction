...
class View5 extends DbTable
{
    ...
    public function __construct()
    {
        ...
        $this->name->Lookup = new Lookup($this->name, 'view5', true, 'name', ["name","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->area->Lookup = new Lookup($this->area, 'view5', true, 'area', ["area","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->price->Lookup = new Lookup($this->price, 'view5', true, 'price', ["price","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->quantity->Lookup = new Lookup($this->quantity, 'view5', true, 'quantity', ["quantity","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->adult->Lookup = new Lookup($this->adult, 'view5', true, 'adult', ["adult","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->children->Lookup = new Lookup($this->children, 'view5', true, 'children', ["children","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->status->Lookup = new Lookup($this->status, 'view5', true, 'status', ["status","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->removed->Lookup = new Lookup($this->removed, 'view5', true, 'removed', ["removed","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "view5";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("View5List");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "View5View" => $Language->phrase("View"),
            "View5Edit" => $Language->phrase("Edit"),
            "View5Add" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "View5View",
            Config("API_ADD_ACTION") => "View5Add",
            Config("API_EDIT_ACTION") => "View5Edit",
            Config("API_DELETE_ACTION") => "View5Delete",
            Config("API_LIST_ACTION") => "View5List",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("View5View", $parm);
        } else {
            $url = $this->keyUrl("View5View", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("View5Edit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("View5List", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("View5List", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("View5Delete", $parm);
        }
    }
