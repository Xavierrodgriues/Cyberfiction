 ...
 * Page class
 */
class MainCourseItemAdd extends MainCourseItem
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MainCourseItemAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "MainCourseItemAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$rsold) { // Record not loaded
                    ...
                    $this->terminate("MainCourseItemList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "MainCourseItemList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "MainCourseItemView") {
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "MainCourseItemList") {
                            ...
                            $returnUrl = "MainCourseItemList"; // Return list page content
                        }
                    }
