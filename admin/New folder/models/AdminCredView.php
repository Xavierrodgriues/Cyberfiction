 ...
 * Page class
 */
class AdminCredView extends AdminCred
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AdminCredView";
    ...
    // CSS class/style
    public $CurrentPageName = "AdminCredView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("sr_no") ?? Route("sr_no")) !== null) {
            ...
            $this->RecKey["sr_no"] = $this->sr_no->QueryStringValue;
        } elseif (Post("sr_no") !== null) {
            $this->sr_no->setFormValue(Post("sr_no"));
            $this->RecKey["sr_no"] = $this->sr_no->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->sr_no->setQueryStringValue($keyValue);
            $this->RecKey["sr_no"] = $this->sr_no->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "AdminCredList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "AdminCredList"; // No matching record, return to list
                    }
                break;
        }
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            ...
            return '<button type="button" class="btn btn-default ew-export-link ew-email" title="' . $Language->phrase("ExportToEmail", true) . '" data-caption="' . $Language->phrase("ExportToEmail", true) . '" form="fadmin_credview" data-ew-action="email" data-hdr="' . $Language->phrase("ExportToEmail", true) . '" data-key="' . ArrayToJsonAttribute($this->RecKey) . '" data-exported-selected="false"' . $url . '>' . $Language->phrase("ExportToEmail") . '</button>';
