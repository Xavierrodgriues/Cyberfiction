...
class View4 extends DbTable
{
    ...
    public function __construct()
    {
        ...
        $this->name->Lookup = new Lookup($this->name, 'view4', true, 'name', ["name","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->phonenum->InputTextType = "number";
        $this->phonenum->Nullable = false; // NOT NULL field
        $this->phonenum->Required = true; // Required field
        $this->phonenum->UseFilter = true; // Table header filter
        $this->phonenum->Lookup = new Lookup($this->phonenum, 'view4', true, 'phonenum', ["phonenum","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->is_verified->Lookup = new Lookup($this->is_verified, 'view4', true, 'is_verified', ["is_verified","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->status->Lookup = new Lookup($this->status, 'view4', true, 'status', ["status","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->datentime->Lookup = new Lookup($this->datentime, 'view4', true, 'datentime', ["datentime","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "view4";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("View4List");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "View4View" => $Language->phrase("View"),
            "View4Edit" => $Language->phrase("Edit"),
            "View4Add" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "View4View",
            Config("API_ADD_ACTION") => "View4Add",
            Config("API_EDIT_ACTION") => "View4Edit",
            Config("API_DELETE_ACTION") => "View4Delete",
            Config("API_LIST_ACTION") => "View4List",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("View4View", $parm);
        } else {
            $url = $this->keyUrl("View4View", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("View4Edit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("View4List", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("View4List", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("View4Delete", $parm);
        }
    }
