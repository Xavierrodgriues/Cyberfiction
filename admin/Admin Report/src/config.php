...
$CONFIG = [
    ...
    "PROJECT_STYLESHEET_FILENAME" => "css/project6.css", // Project stylesheet file name
    ...
    "SIDEBAR_CLASS" => "main-sidebar sidebar-dark-gray-dark", // CSS class(es) for sidebar
    "NAVBAR_CLASS" => "main-header navbar navbar-expand navbar-gray-dark navbar-dark border-bottom-0", // CSS class(es) for navbar
    ...
    "AES_ENCRYPTION_KEY" => "ipffoh7OuIjW+J4mpqiOzH8OFS9IWovV2fFg7sWK7Bo=", // AES encryption key (base64 encoded)
    ...
    "AUTH_CONFIG" => [
        "providers" => [
            ...
            "Azure" => [
                "enabled" => false,
                "adapter" => 'PHPMaker2024\\project6\\AzureAD',
                "keys" => [
                    "id" => '',
            ...
            "Saml" => [
                "enabled" => false,
                "adapter" => 'PHPMaker2024\\project6\\Saml2',
    ...
    // Export Log
    "EXPORT_PATH" => "export-009224ee-aed9-43f4-b35c-74b407408222", // Export folder
