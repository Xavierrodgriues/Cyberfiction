...
// Product version
define(PROJECT_NAMESPACE . "PRODUCT_VERSION", "24.8.0");

// Project
define(PROJECT_NAMESPACE . "PROJECT_NAME", "project6"); // Project name
define(PROJECT_NAMESPACE . "PROJECT_ID", "{009224EE-AED9-43F4-B35C-74B407408222}"); // Project ID
