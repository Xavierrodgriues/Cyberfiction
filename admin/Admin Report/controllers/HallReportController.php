...
class HallReportController extends ControllerBase
{
    // list
    #[Map(["GET","POST","OPTIONS"], "/HallReportList", [PermissionMiddleware::class], "list.hall_report")]
    public function list(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "HallReportList");
    }
}
