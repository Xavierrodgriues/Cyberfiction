 ...
 */
class UserReport extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->name->Lookup = new Lookup($this->name, 'user_report', true, 'name', ["name","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->dob->UseFilter = true; // Table header filter
        $this->dob->Lookup = new Lookup($this->dob, 'user_report', true, 'dob', ["dob","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->is_verified->Lookup = new Lookup($this->is_verified, 'user_report', true, 'is_verified', ["is_verified","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->status->Lookup = new Lookup($this->status, 'user_report', true, 'status', ["status","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->datentime->Lookup = new Lookup($this->datentime, 'user_report', true, 'datentime', ["datentime","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`user report`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("UserReportList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "UserReportView" => $Language->phrase("View"),
            "UserReportEdit" => $Language->phrase("Edit"),
            "UserReportAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "UserReportView",
            Config("API_ADD_ACTION") => "UserReportAdd",
            Config("API_EDIT_ACTION") => "UserReportEdit",
            Config("API_DELETE_ACTION") => "UserReportDelete",
            Config("API_LIST_ACTION") => "UserReportList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("UserReportView", $parm);
        } else {
            $url = $this->keyUrl("UserReportView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("UserReportEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("UserReportList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("UserReportAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("UserReportList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("UserReportDelete", $parm);
        }
    }
