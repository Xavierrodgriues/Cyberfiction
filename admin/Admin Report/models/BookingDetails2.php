...
/**
 * Table class for booking details
 */
class BookingDetails2 extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "`booking details`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->room_name->Lookup = new Lookup($this->room_name, 'booking_details2', true, 'room_name', ["room_name","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->price->Lookup = new Lookup($this->price, 'booking_details2', true, 'price', ["price","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->total_pay->Lookup = new Lookup($this->total_pay, 'booking_details2', true, 'total_pay', ["total_pay","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->user_name->Lookup = new Lookup($this->user_name, 'booking_details2', true, 'user_name', ["user_name","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->check_in->Lookup = new Lookup($this->check_in, 'booking_details2', true, 'check_in', ["check_in","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->check_out->Lookup = new Lookup($this->check_out, 'booking_details2', true, 'check_out', ["check_out","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->refund->InputTextType = "number";
        $this->refund->Raw = true;
        $this->refund->UseFilter = true; // Table header filter
        $this->refund->Lookup = new Lookup($this->refund, 'booking_details2', true, 'refund', ["refund","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->booking_status->Lookup = new Lookup($this->booking_status, 'booking_details2', true, 'booking_status', ["booking_status","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->trans_amt->InputTextType = "number";
        ...
        $this->trans_amt->Lookup = new Lookup($this->trans_amt, 'booking_details2', true, 'trans_amt', ["trans_amt","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->trans_status->Lookup = new Lookup($this->trans_status, 'booking_details2', true, 'trans_status', ["trans_status","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->datentime->InputTextType = "month";
        ...
        $this->datentime->Lookup = new Lookup($this->datentime, 'booking_details2', true, 'datentime', ["datentime","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`booking details`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("BookingDetails2List");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "BookingDetails2View" => $Language->phrase("View"),
            "BookingDetails2Edit" => $Language->phrase("Edit"),
            "BookingDetails2Add" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "BookingDetails2View",
            Config("API_ADD_ACTION") => "BookingDetails2Add",
            Config("API_EDIT_ACTION") => "BookingDetails2Edit",
            Config("API_DELETE_ACTION") => "BookingDetails2Delete",
            Config("API_LIST_ACTION") => "BookingDetails2List",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("BookingDetails2View", $parm);
        } else {
            $url = $this->keyUrl("BookingDetails2View", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "BookingDetails2Add?" . $parm;
        } else {
            $url = "BookingDetails2Add";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("BookingDetails2Edit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("BookingDetails2List", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("BookingDetails2Add", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("BookingDetails2List", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("BookingDetails2Delete", $parm);
        }
    }
