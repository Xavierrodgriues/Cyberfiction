...
/**
 * Table class for hall report
 */
class HallReport extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->name->UseFilter = true; // Table header filter
        $this->name->Lookup = new Lookup($this->name, 'hall_report', true, 'name', ["name","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->area->Lookup = new Lookup($this->area, 'hall_report', true, 'area', ["area","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->price->Lookup = new Lookup($this->price, 'hall_report', true, 'price', ["price","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->quantity->Lookup = new Lookup($this->quantity, 'hall_report', true, 'quantity', ["quantity","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->adult->UseFilter = true; // Table header filter
        $this->adult->Lookup = new Lookup($this->adult, 'hall_report', true, 'adult', ["adult","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->children->UseFilter = true; // Table header filter
        $this->children->Lookup = new Lookup($this->children, 'hall_report', true, 'children', ["children","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->description->Lookup = new Lookup($this->description, 'hall_report', true, 'description', ["description","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->status->Lookup = new Lookup($this->status, 'hall_report', true, 'status', ["status","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->removed->UseFilter = true; // Table header filter
        $this->removed->Lookup = new Lookup($this->removed, 'hall_report', true, 'removed', ["removed","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`hall report`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("HallReportList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "HallReportView" => $Language->phrase("View"),
            "HallReportEdit" => $Language->phrase("Edit"),
            "HallReportAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "HallReportView",
            Config("API_ADD_ACTION") => "HallReportAdd",
            Config("API_EDIT_ACTION") => "HallReportEdit",
            Config("API_DELETE_ACTION") => "HallReportDelete",
            Config("API_LIST_ACTION") => "HallReportList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("HallReportView", $parm);
        } else {
            $url = $this->keyUrl("HallReportView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("HallReportEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("HallReportList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("HallReportAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("HallReportList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("HallReportDelete", $parm);
        }
    }
