...
<body class="bg-light">
    ...
    <div class="container-fluid">
        ...
        <img src="$path$row[image]" class="w-100 d-block" style="height: 650px; width: auto;" />
      </div>
    data;
                }
                ?>
    ...
    <div class="container">
        <div class="row">
            ...
            while ($room_data = mysqli_fetch_assoc($room_res)) {
                ...
                $fea_q = mysqli_query($con, "SELECT f.name FROM `features` f INNER JOIN `room_features` rfea 
                ON f.sr_no = rfea.features_id WHERE rfea.room_id = '$room_data[id]'");
                $features_data = '';
...
data;
            ...
            <div class="col-lg-12 text-center mt-5">
                <a href="rooms.php" class="btn btn-sm btn-outline-dark rounded-0 fw-bold shadow-none">More Halls >>></a>
            </div>
        </div>
    </div>
    ...
    <div class="container mt-5">
        <div class="swiper swiper-testimonials shadow">
            <div class="swiper-wrapper mb-5">
                <?php
                $review_q = "SELECT rr.*,uc.name AS uname, r.name AS rname, uc.profile FROM `rating_review` rr
                    ...
                    while ($row = mysqli_fetch_assoc($review_res)) {
                        ...
                        <div class="swiper-slide bg-white p-4">
                            <div class="profile d-flex align-items-center mb-3">
                                <img src="$img_path$row[profile]" class="rounded-circle" loading="lazy" width="30px" alt="" />
    ...
    if (isset($_GET['account_recovery'])) {
        ...
        if (mysqli_num_rows($query) == 1) {
            ...
            showModel;
            // alert('sucess',"Invalid or expired Link");
        } else {
        ...
        recovery_form.addEventListener(('submit'), (e) => {
            ...
            xhr.onload = function() {
                if (this.responseText == 'failed') {
                    ...
                    alert('success', "Account Rest Successfull!");
                    recovery_form.reset();
                }
            }
            xhr.send(data);
