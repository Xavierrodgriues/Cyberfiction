...
/**
 * Table class for bookingorder report
 */
class BookingorderReport extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "`bookingorder report`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->check_in->Lookup = new Lookup($this->check_in, 'bookingorder_report', true, 'check_in', ["check_in","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->check_out->Lookup = new Lookup($this->check_out, 'bookingorder_report', true, 'check_out', ["check_out","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->refund->Lookup = new Lookup($this->refund, 'bookingorder_report', true, 'refund', ["refund","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->booking_status->Lookup = new Lookup($this->booking_status, 'bookingorder_report', true, 'booking_status', ["booking_status","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->name->Lookup = new Lookup($this->name, 'bookingorder_report', true, 'name', ["name","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->price->Lookup = new Lookup($this->price, 'bookingorder_report', true, 'price', ["price","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->status->Lookup = new Lookup($this->status, 'bookingorder_report', true, 'status', ["status","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->is_verified->UseFilter = true; // Table header filter
        $this->is_verified->Lookup = new Lookup($this->is_verified, 'bookingorder_report', true, 'is_verified', ["is_verified","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`bookingorder report`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("BookingorderReportList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "BookingorderReportView" => $Language->phrase("View"),
            "BookingorderReportEdit" => $Language->phrase("Edit"),
            "BookingorderReportAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "BookingorderReportView",
            Config("API_ADD_ACTION") => "BookingorderReportAdd",
            Config("API_EDIT_ACTION") => "BookingorderReportEdit",
            Config("API_DELETE_ACTION") => "BookingorderReportDelete",
            Config("API_LIST_ACTION") => "BookingorderReportList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("BookingorderReportView", $parm);
        } else {
            $url = $this->keyUrl("BookingorderReportView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "BookingorderReportAdd?" . $parm;
        } else {
            $url = "BookingorderReportAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("BookingorderReportEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("BookingorderReportList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("BookingorderReportAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("BookingorderReportList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("BookingorderReportDelete", $parm);
        }
    }
    ...
    {
        global $Response;
        $listPage = "BookingorderReportList";
