...
/**
 * Table class for starter_item
 */
class StarterItem extends DbTable
{
    protected $SqlFrom = "";
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "starter_item";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("StarterItemList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "StarterItemView" => $Language->phrase("View"),
            "StarterItemEdit" => $Language->phrase("Edit"),
            "StarterItemAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "StarterItemView",
            Config("API_ADD_ACTION") => "StarterItemAdd",
            Config("API_EDIT_ACTION") => "StarterItemEdit",
            Config("API_DELETE_ACTION") => "StarterItemDelete",
            Config("API_LIST_ACTION") => "StarterItemList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("StarterItemView", $parm);
        } else {
            $url = $this->keyUrl("StarterItemView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("StarterItemEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("StarterItemList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("StarterItemAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("StarterItemList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("StarterItemDelete", $parm);
        }
    }
