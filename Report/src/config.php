...
$CONFIG = [
    ...
    "AES_ENCRYPTION_KEY" => "9LTliIHMpvGlAcJ0DK7Ev6DXAl5sNR84xKgDYKICwlk=", // AES encryption key (base64 encoded)
    ...
    "AUTH_CONFIG" => [
        "providers" => [
            ...
            "Azure" => [
                "enabled" => false,
                "adapter" => 'PHPMaker2024\\project2\\AzureAD',
                "keys" => [
                    "id" => '',
            ...
            "Saml" => [
                "enabled" => false,
                "adapter" => 'PHPMaker2024\\project2\\Saml2',
    ...
    // Export Log
    "EXPORT_PATH" => "export-7815439a-a3c3-4bbf-a986-68d3ad45df3d", // Export folder
