...
Type::addType("geometry", "PHPMaker2024\\project2\\GeometryType"); // "geometry" type
Type::addType("geography", "PHPMaker2024\\project2\\GeographyType"); // "geography" type
Type::addType("hierarchyid", "PHPMaker2024\\project2\\HierarchyIdType"); // "hierarchyid" type
Type::addType("bytes", "PHPMaker2024\\project2\\BytesType"); // "bytes" type
